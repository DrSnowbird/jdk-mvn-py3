...
#### ---------------------------------------------------------------
ARG JAVA_MAJOR_VERSION=${JAVA_MAJOR_VERSION}
ARG JAVA_UPDATE_VERSION=${JAVA_UPDATE_VERSION}
ARG JAVA_BUILD_NUMBER=${JAVA_BUILD_NUMBER}
ARG JAVA_DOWNLOAD_TOKEN=${JAVA_DOWNLOAD_TOKEN}
